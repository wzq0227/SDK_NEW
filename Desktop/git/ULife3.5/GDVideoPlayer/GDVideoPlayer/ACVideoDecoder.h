...
typedef long (* EncodeAACCallBack)(unsigned char* lpBuf, long lSize, long lUserParam);
...
- (void)ac_encodePCM2AACWithSample:(int)sample
                           channel:(int)channel
                          inputBuf:(unsigned  char *)pInData
                          inputLen:(int)nInLen
                            outBuf:(unsigned  char **)pOutData
...
- (void)ac_encodeAACStartWithSample:(int)sampleRate channel:(int)channel callback:(EncodeAACCallBack)encCallback userParam:(int)userParam;

- (void)ac_encodeAACStop;

- (void)ac_encodeAACPutBuffer:(unsigned char *)pBuffer length:(int)length;
