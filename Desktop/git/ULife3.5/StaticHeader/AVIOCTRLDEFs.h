...
typedef enum
{
    ...
    IOTYPE_USER_IPCAM_DEVICE_DELETE_RECORDFILE_REQ    = 0x0790,//删除sd卡录像文件请求
    IOTYPE_USER_IPCAM_DEVICE_DELETE_RECORDFILE_RESP    = 0x0791,
    ...
    IOTYPE_USER_IPCAM_GET_CAMEREA_STATUS_RESP        = 0x1005,
    
    IOTYPE_USER_IPCAM_GET_DELETE_CAMEREA_PAIR_REQ   = 0x1006,//请求删除门铃的配对
    IOTYPE_USER_IPCAM_GET_DELETE_CAMEREA_PAIR_RESP    = 0x1007,
    
    IOTYPE_USER_IPCAM_SET_DOORBELL_RING_REMIND_REQ           = 0x1008,  //设置门铃铃声提醒开关
    IOTYPE_USER_IPCAM_SET_DOORBELL_RING_REMIND_RESP            = 0x1009,
    
    IOTYPE_USER_IPCAM_SET_DOORBELL_LED_REMIND_REQ           = 0x100a,  //设置门铃LED提醒开关
    IOTYPE_USER_IPCAM_SET_DOORBELL_LED_REMIND_RESP            = 0x100b,
    
    IOTYPE_USER_IPCAM_SET_CHANNEL_PIRDETECT_REQ             = 0x100C,    //设置PIR红外侦测参数请求，增加通道管理
    IOTYPE_USER_IPCAM_SET_CHANNEL_PIRDETECT_RESP            = 0x100D,    //设置PIR红外侦测参数请求应答，增加通道管理
    
    IOTYPE_USER_IPCAM_GET_CHANNEL_PIRDETECT_REQ             = 0x100E,    //获取PIR红外侦测参数请求，增加通道管理
    IOTYPE_USER_IPCAM_GET_CHANNEL_PIRDETECT_RESP            = 0x100F,    //获取PIR红外侦测参数请求应答，增加通道管理

    
    IOTYPE_USER_IPCAM_ADD_SUB_DEVICE_SUCCESSFUL_MSG        = 0x1010,    //添加子设备成功，通知中继
    IOTYPE_USER_IPCAM_ADD_SUB_DEVICE_SUCCESSFUL_MSG_RESP     = 0x1011,    //添加子设备成功，通知中继结果返回
    
    IOTYPE_USER_IPCAM_DELETE_SUB_DEVICE_SUCCESSFUL_MSG        = 0x1012,    //删除子设备成功，通知中继
    IOTYPE_USER_IPCAM_DELETE_SUB_DEVICE_SUCCESSFUL_MSG_RESP     = 0x1013,    //删除子设备成功，通知中继结果返回
    
    IOTYPE_USER_IPCAM_GET_SUB_DEVICE_INFO_REQ     = 0x1014,                //获取子设备信息请求
    IOTYPE_USER_IPCAM_GET_SUB_DEVICE_INFO_RESP     = 0x1015,                //获取子设备信息回复
    
    IOTYPE_USER_IPCAM_SET_GATEWAY_VOLUME_REQ     = 0x1016,                //设置中继音量请求
    IOTYPE_USER_IPCAM_SET_GATEWAY_VOLUME_RESP     = 0x1017,                //设置中继音量回复
    
    IOTYPE_USER_IPCAM_GET_GATEWAY_VOLUME_REQ     = 0x1018,                //获取中继音量请求
    IOTYPE_USER_IPCAM_GET_GATEWAY_VOLUME_RESP     = 0x1019,                //获取中继音量回复
...
//    char resered[64];
//    int facecount;
//    char face[0]; //facecount*ai_faceinfo
//}SAiInfo;
