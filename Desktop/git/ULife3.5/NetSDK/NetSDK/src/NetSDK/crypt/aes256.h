...
long aes256_cbc_enc_by_head(unsigned char *head, unsigned int headLen, unsigned char *data, unsigned int dataLen, unsigned char **encData, unsigned int *encDataLen, unsigned char key[32]);
