...
typedef enum
{
    ...
    kNETPRO_STREAM_LIVE            = 0x03, // 4.0直播
    kNETPRO_STREAM_REC            = 0x04, // SD录像回放
}kNetStreamType;
// 定义设备流类型 end
...
typedef enum
{
    ...
    kNETPRO_PARAM_GET_CAMEREA_STATUS = 134,
    kNETPRO_PARAM_SET_LOCAL_STORE_CFG = 135,
    kNETPRO_PARAM_SET_LOCAL_STORE_STOP = 136,
    kNETPRO_PRRAM_GET_AI_INFO = 137,  //AI帧
}kNetProParam;
// 定义参数控制命令 end
