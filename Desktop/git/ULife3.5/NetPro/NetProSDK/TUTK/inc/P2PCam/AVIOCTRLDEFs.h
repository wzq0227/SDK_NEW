...
typedef enum 
{
	...
	P2P_USER_TALK_SENDFILE						= 0X00F3,	// p2p对讲发送文件
	...
	IOTYPE_USER_IPCAM_PLAY_RECORD_REQ			= 0x031C, 	//历史回放,缩略图,剪接
	...
	IOTYPE_USER_IPCAM_GET_CAMEREA_STATUS_REQ       	= 0x1004,//获取门铃状态  
	IOTYPE_USER_IPCAM_GET_CAMEREA_STATUS_RESP		= 0x1005,// CAMEREA_STATUS
...
//    IOTYPE_USER_IPCAM_SET_SAVE_DROPBOX_RESP     = 0x0503,
    ...
    IOTYPE_USER_IPCAM_GET_BATTERY_LEVEL_REQ          = 0x0800,//获取电池电量
    IOTYPE_USER_IPCAM_GET_BATTERY_LEVEL_RESP        = 0x0801,
    IOTYPE_USER_IPCAM_GET_NETLINKSIGNAL_REQ          = 0x0802,//获取网关与路由器连接信号强度
    IOTYPE_USER_IPCAM_GET_NETLINKSIGNAL_RESP         = 0x0803,
    
    
    IOTYPE_USER_IPCAM_GET_DELETE_CAMEREA_PAIR_REQ   = 0x1006,   //请求删除门铃的配对
    IOTYPE_USER_IPCAM_GET_DELETE_CAMEREA_PAIR_RESP  = 0x1007,
    
    IOTYPE_USER_IPCAM_SET_ADD_NEW_IOT_SENSOR_REQ      = 0x0900,   // 添加新 IOT Sensor 请求
    IOTYPE_USER_IPCAM_SET_ADD_NEW_IOT_SENSOR_RESP     = 0x0901,   // 添加新 IOT Sensor 应答
    IOTYPE_USER_IPCAM_SET_DELETE_IOT_SENSOR_REQ       = 0x0902,   // 删除新 IOT Sensor 请求
    IOTYPE_USER_IPCAM_SET_DELETE_IOT_SENSOR_RESP      = 0x0903,   // 删除新 IOT Sensor 应答
    IOTYPE_USER_IPCAM_SET_IOT_SENSOR_STATE_REQ        = 0x0904,   // 设置 IOT Sensor 参数请求
    IOTYPE_USER_IPCAM_SET_IOT_SENSOR_STATE_RESP       = 0x0905,   // 设置 IOT Sensor 参数应答
    IOTYPE_USER_IPCAM_GET_IOT_SENSOR_STATE_REQ        = 0x0906,   // 获取 IOT Sensor 参数请求
    IOTYPE_USER_IPCAM_GET_IOT_SENSOR_STATE_RESP       = 0x0907,   // 获取 IOT Sensor 参数应答
    IOTYPE_USER_IPCAM_PAIR_IOT_STROBE_SIREN_REQ       = 0x0908,   // 配对声光报警器请求
    IOTYPE_USER_IPCAM_PAIR_IOT_STROBE_SIREN_RESP      = 0x0909,   // 配对声光报警器应答
    IOTYPE_USER_IPCAM_STOP_IOT_STROBE_SIREN_REQ       = 0x090a,   // 停止 声光报警器 报警请求
    IOTYPE_USER_IPCAM_STOP_IOT_STROBE_SIREN_RESP      = 0x090b,   // 停止 声光报警器  报警应答
    IOTYPE_USER_IPCAM_SET_IOT_STROBE_SIREN_STATE_REQ  = 0x090c,   // 设置声光报警器的报警开关请求
    IOTYPE_USER_IPCAM_SET_IOT_STROBE_SIREN_STATE_RESP = 0x090d,   // 设置声光报警器的报警开关应答
    IOTYPE_USER_IPCAM_GET_IOT_STROBE_SIREN_STATE_REQ  = 0x090e,   // 获取声光报警器的报警开关请求
    IOTYPE_USER_IPCAM_GET_IOT_STROBE_SIREN_STATE_RESP = 0x090f,   // 获取声光报警器的报警开关应答
    IOTYPE_USER_IPCAM_SET_PREPARE_NEW_IOT_SENSOR_REQ  = 0x0910,   // 准备添加新 IOT Sensor 请求
    IOTYPE_USER_IPCAM_SET_PREPARE_NEW_IOT_SENSOR_RESP = 0x0911,   // 准备添加新 IOT Sensor 应答
    IOTYPE_USER_IPCAM_SET_CHECK_NEW_IOT_SENSOR_REQ    = 0x0912,   // 检查添加新 IOT Sensor 状态请求
    IOTYPE_USER_IPCAM_SET_CHECK_NEW_IOT_SENSOR_RESP   = 0x0913,   // 检查添加新 IOT Sensor 状态应答
    IOTYPE_USER_IPCAM_STOP_IOT_SENSOR_ALARM_REQ       = 0x0914,   // 停止sos设备端报警声 请求
    IOTYPE_USER_IPCAM_STOP_IOT_SENSOR_ALARM_RESP      = 0x0915,   // 停止sos设备端报警声 应答
...
#define TCP_NOTIFY_MSG_TYPE_START 10000
#define TCP_NOTIFY_MSG_TYPE_AI_INFO (TCP_NOTIFY_MSG_TYPE_START+1) //10001
...
typedef enum _CAMEREA_STATUS
{
	E_SDK_NORMAL = 0, 	//正常，已经配对并且在线
	E_SDK_NO_ONLINE,	//配对了，但是不在线	
	E_SDK_NO_PAIR,		//没有配对
	E_SDK_ERROR,		//异常
}CAMEREA_STATUS;
...
typedef struct
{
	unsigned int alarm_msg_req; 		// 安卓 1， IOS 0
