...
@interface CloudSDCardViewController ()<
...
@implementation CloudSDCardViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    UILabel *tLabel = [CommonlyUsedFounctions titleLabelWithStr:[NSString stringWithFormat:@"%@-%@",_deviceName,DPLocalizedString(@"PlayVideo_TF")]];
