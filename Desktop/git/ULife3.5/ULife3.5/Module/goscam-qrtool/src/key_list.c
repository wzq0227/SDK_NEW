...
int key_list_add(key_list_t *list,key_t key,value_t _value)
{
...
int key_list_get(key_list_t *list,key_t key,value_t *_value)
{
...
int key_list_edit(key_list_t *list,key_t key,value_t _value)
{
	key_list_node_t* node = key_list_get_node(list,key);
	if (node == NULL) {
		return -1;
